...
def Validate_CL_Embedding_ST(model_epoch, learning_name, sample, adata, embedding_path, meta_path, cluster_result_path, validate_model_epoch):
    ...
    for epoch_num in epoch_list:
        ...
        #embedding_ari 
        emb1_cl1_ari_current, emb1_cl1_label_save_current =  Embedding_Kmeans_Result_ST(emb1_cl1_np,sample,adata,meta_path)
        emb1_cl2_ari_current, emb1_cl2_label_save_current =  Embedding_Kmeans_Result_ST(emb1_cl2_np,sample,adata,meta_path)
        emb2_cl1_ari_current, emb2_cl1_label_save_current =  Embedding_Kmeans_Result_ST(emb2_cl1_np,sample,adata,meta_path)
        emb2_cl2_ari_current, emb2_cl2_label_save_current =  Embedding_Kmeans_Result_ST(emb2_cl2_np,sample,adata,meta_path)
        emb1_norm_cl1_ari_current, emb1_norm_cl1_label_save_current =  Embedding_Kmeans_Result_ST(emb1_cl1_norm_np,sample,adata,meta_path)
        emb1_norm_cl2_ari_current, emb1_norm_cl2_label_save_current =  Embedding_Kmeans_Result_ST(emb1_cl2_norm_np,sample,adata,meta_path)
...
#A1 5 + undetermined    #adipose tissue  #cancer in situ  #connective tissue  #immune infiltrate  #invasive cancer
#B1 4 + undetermined    #adipose tissue  #breast glands  #connective tissue  #invasive cancer
#C1 3 + undetermined    #adipose tissue  #connective tissue  #invasive cancer  
#D1 3 + undetermined    #connective tissue  #immune infiltrate  #invasive cancer  
#E1 3 + undetermined    #connective tissue  #immune infiltrate  #invasive cancer
#F1 3 + undetermined    #connective tissue  #immune infiltrate  #invasive cancer
#G2 6 + undetermined    #adipose tissue  #breast glands  #cancer in situ  #connective tissue  #immune infiltrate  #invasive cancer
#H1 6 + undetermined    #adipose tissue  #breast glands  #cancer in situ  #connective tissue  #immune infiltrate  #invasive cancer

def Embedding_Kmeans_Result_ST(embedding, sample, adata, meta_path):
    #set embedding
