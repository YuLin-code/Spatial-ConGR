...
if __name__ == "__main__":
    ...
    sample_name_list = ['A1','B1','C1','D1','E1','F1','G2','H1']
    ...
    emb1_norm_cl1_ari_list_ave_std_pd.to_csv(result_tmp_path+learning_name+'_crop'+str(crop_diameter)+'_patch'+str(patch_target_size)+'_check'+str(check)+'_emb1_norm_cl1_ari_ave_std.csv')  
    ...
    emb1_norm_cl2_ari_list_ave_std_pd.to_csv(result_tmp_path+learning_name+'_crop'+str(crop_diameter)+'_patch'+str(patch_target_size)+'_check'+str(check)+'_emb1_norm_cl2_ari_ave_std.csv')  
    ...
    emb1_cl1_ari_list_ave_std_pd.to_csv(result_tmp_path+learning_name+'_crop'+str(crop_diameter)+'_patch'+str(patch_target_size)+'_check'+str(check)+'_emb1_cl1_ari_ave_std.csv')  
    ...
    emb2_cl1_ari_list_ave_std_pd.to_csv(result_tmp_path+learning_name+'_crop'+str(crop_diameter)+'_patch'+str(patch_target_size)+'_check'+str(check)+'_emb2_cl1_ari_ave_std.csv')
    ...
    emb1_cl2_ari_list_ave_std_pd.to_csv(result_tmp_path+learning_name+'_crop'+str(crop_diameter)+'_patch'+str(patch_target_size)+'_check'+str(check)+'_emb1_cl2_ari_ave_std.csv') 
    ...
    emb2_cl2_ari_list_ave_std_pd.to_csv(result_tmp_path+learning_name+'_crop'+str(crop_diameter)+'_patch'+str(patch_target_size)+'_check'+str(check)+'_emb2_cl2_ari_ave_std.csv')