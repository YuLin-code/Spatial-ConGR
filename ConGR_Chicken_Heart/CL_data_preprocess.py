...
def load_chicken_heart_image_data(image_path, sample, adata):

    img_3d_pil_rgb = Image.open(image_path)
    img_3d_np_rgb = np.array(img_3d_pil_rgb)
    ...
    return img_3d_np_rgb, crop_radius, spot_row_in_fullres, spot_col_in_fullres
...
def generate_coords_chicken_heart_use_exp(anndata, metadata_path, select_gene_num):
