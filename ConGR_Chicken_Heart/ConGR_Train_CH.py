...
from CL_data_preprocess import load_chicken_heart_data, generate_coords_chicken_heart_use_exp, load_chicken_heart_image_data, image_data_prepare_tile, normalization_min_max
from util_function import Validate_CL_chicken_heart_Embedding
import random
...
def parse_args():
    ...
    # original
    parser.add_argument('-sample', type=str, nargs='+', default=['D4'], help='which sample to generate: D4, D7, D10, D14.')
...
if __name__ == "__main__":
    ...
    coords, use_expression_np= generate_coords_chicken_heart_use_exp(adata, metadata_path ,select_gene_num)
    ...
    #load image data 
    img_3d, crop_radius, spot_row_in_fullres, spot_col_in_fullres = load_chicken_heart_image_data(image_path, sample, adata)
    ...
    Validate_CL_chicken_heart_Embedding(model_epoch, learning_name, sample, adata, embedding_path, metadata_path, cluster_result_path, validate_model_epoch)
